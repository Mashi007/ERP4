    ...
    if (sql) {
      await sql`
        ...
        VALUES (
          ...
          'Completada',
          ${'Oportunidad creada desde módulo de Oportunidades. ' + (contactCreated ? 'Nuevo contacto creado.' : 'Contacto existente vinculado.')},
          'Daniel Casañas'
        )
      `
    }
    ...
    if (sql) {
      ...
      await sql`
        ...
        VALUES (
          ...
          ${new Date().toISOString().split('T')[0]},
          'Completada',
          ${'La oportunidad fue actualizada desde el módulo de Oportunidades'},
          'Daniel Casañas'
        )
      `
    } else {
    ...
    if (sql) {
      ...
      await sql`
        ...
        VALUES (
          ...
          ${new Date().toISOString().split('T')[0]},
          'Completada',
          'La oportunidad fue eliminada desde el módulo de Oportunidades',
          'Daniel Casañas'
        )
      `
    } else {
